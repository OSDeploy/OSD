...
'@
    ...
    if ($null -eq $WindowsAdkPaths) {
        Write-Host -ForegroundColor DarkGray "========================================================================="
        Write-Warning "[$(Get-Date -format s)] Could not get ADK going, sorry"
        Write-Host -ForegroundColor DarkGray "========================================================================="
        Break
    }
    #endregion
    ...
    if ($PSBoundParameters.ContainsKey('WinRE')) {
        if ((Get-WinREPartition).OperationalStatus -ne 'Online') {
            Write-Host -ForegroundColor DarkGray "========================================================================="
            Write-Warning "[$(Get-Date -format s)] You can't use WinRE because of some issue.  Sorry!"
            Write-Host -ForegroundColor DarkGray "========================================================================="
            Break
        }
        if ((Get-RegCurrentVersion).CurrentBuild -gt 20000) {
            #Write-Host -ForegroundColor DarkGray "========================================================================="
            #Write-Warning "[$(Get-Date -format s)] Windows 11 WinRE may not support booting some Virtual Machines"
            #Write-Warning "[$(Get-Date -format s)] It is recommended that you remove the -WinRE parameter if you need Virtual Machine support"
            #Write-Warning "[$(Get-Date -format s)] Press Ctrl+C to cancel in the next 10 seconds"
    ...
    if (-NOT (Test-Path $WimSourcePath)) {
        Write-Host -ForegroundColor DarkGray "========================================================================="
        Write-Warning "[$(Get-Date -format s)] Could not find the ADK WimSourcePath: $WimSourcePath"
        Write-Host -ForegroundColor DarkGray "========================================================================="
        Break
    }
    #endregion
    ...
    if (-NOT (Test-Path $OSDCloudTemplate)) {
        Write-Host -ForegroundColor Cyan "[$(Get-Date -format s)] Creating OSDCloud Template: $OSDCloudTemplate"
    ...
    Write-Host -ForegroundColor Cyan "[$(Get-Date -format s)] Creating OSDCloud Template Logs at $TemplateLogs"
    ...
    if ($PSBoundParameters.ContainsKey('WinRE')) {
        Write-Host -ForegroundColor Cyan "[$(Get-Date -format s)] Copying WinRE.wim"
        ...
        Write-Host -ForegroundColor Cyan "[$(Get-Date -format s)] Copying ADK WinPE.wim"
    ...
    Write-Host -ForegroundColor DarkGray "========================================================================="
    Write-Host -ForegroundColor Cyan "[$(Get-Date -format s)] Mount Boot.wim"
    ...
    if ($PSBoundParameters.ContainsKey('WinRE')) {
        ...
        #=================================================
        Write-Host -ForegroundColor DarkGray "========================================================================="
        Write-Host -ForegroundColor Cyan "[$(Get-Date -format s)] WinRE Wallpaper"
        ...
        #=================================================
        Write-Host -ForegroundColor DarkGray "========================================================================="
        Write-Host -ForegroundColor Cyan "[$(Get-Date -format s)] WinRE Wireless"
    ...
    Write-Host -ForegroundColor DarkGray "========================================================================="
    Write-Host -ForegroundColor Cyan "[$(Get-Date -format s)] Adding default en-US ADK Packages"
    ...
    foreach ($Lang in $Language) {
        Write-Host -ForegroundColor DarkGray "========================================================================="
        Write-Host -ForegroundColor Cyan "[$(Get-Date -format s)] Adding $Lang ADK Packages"
        Write-Host -ForegroundColor Yellow "Dism Function: Add-WindowsPackage"
    ...
    if ($SetAllIntl -or $SetInputLocale) {
        Write-Host -ForegroundColor DarkGray "========================================================================="
        Write-Host -ForegroundColor Cyan "[$(Get-Date -format s)] Current Get-Intl Settings"
        $CurrentLog = "$TemplateLogs\$((Get-Date).ToString('yyyy-MM-dd-HHmmss'))-Get-Intl.log"
        Dism /image:"$MountPath" /Get-Intl /LogPath:"$CurrentLog"
    }

    if ($SetAllIntl) {
        Write-Host -ForegroundColor Cyan "[$(Get-Date -format s)] Applying Set-AllIntl"
    ...
    if ($SetInputLocale) {
        Write-Host -ForegroundColor Cyan "[$(Get-Date -format s)] Applying Set-InputLocale"
    ...
    if ($SetAllIntl -or $SetInputLocale) {
        Write-Host -ForegroundColor Cyan "[$(Get-Date -format s)] Updated Get-Intl Settings"
        $CurrentLog = "$TemplateLogs\$((Get-Date).ToString('yyyy-MM-dd-HHmmss'))-Get-Intl.log"
        Dism /image:"$MountPath" /Get-Intl /LogPath:"$CurrentLog"
    }
    #endregion
    ...
    Write-Host -ForegroundColor DarkGray "========================================================================="
    Write-Host -ForegroundColor Cyan "[$(Get-Date -format s)] WinPE Additional Files"
    #=================================================
    #	curl.exe
    #=================================================
    ...
    #=================================================
    Write-Host -ForegroundColor DarkGray "========================================================================="
    Write-Host -ForegroundColor Cyan "[$(Get-Date -format s)] Microsoft DaRT Config from MDT"
    ...
    #=================================================
    Write-Host -ForegroundColor DarkGray "========================================================================="
    Write-Host -ForegroundColor Cyan "[$(Get-Date -format s)] Microsoft DaRT"
    ...
    Write-Host -ForegroundColor DarkGray "========================================================================="
    Write-Host -ForegroundColor Cyan "[$(Get-Date -format s)] Set WinPE PowerShell ExecutionPolicy to Bypass"
    ...
    Write-Host -ForegroundColor DarkGray "========================================================================="
    Write-Host -ForegroundColor Cyan "[$(Get-Date -format s)] Enable WinPE PowerShell Gallery"
    ...
    if (Test-Path $SourceFile) {
        Write-Host -ForegroundColor DarkGray "========================================================================="
        Write-Host -ForegroundColor Cyan "[$(Get-Date -format s)] Removing WinRE $SourceFile"
    ...
    Write-Host -ForegroundColor DarkGray "========================================================================="
    Write-Host -ForegroundColor Cyan "[$(Get-Date -format s)] Modifying WinPE CMD and PowerShell Console settings"
...
<#     reg add "HKLM\Default\Software\Microsoft\Windows NT\CurrentVersion\AppCompatFlags\Layers" /t REG_SZ /v "X:\Windows\System32\WirelessConnect.exe" /d "~ HIGHDPIAWARE" /f
    ...
    if ($CumulativeUpdate) {
        Write-Host -ForegroundColor DarkGray "========================================================================="
        Write-Host -ForegroundColor Cyan "[$(Get-Date -format s)] Apply Cumulative Update"
        ...
        Write-Host -ForegroundColor DarkGray "========================================================================="
        Write-Host -ForegroundColor Cyan "[$(Get-Date -format s)] Updated WinPE Information"
        ...
        if ($WinPECurrentInfo.UBR -eq $WinPEUpdatedInfo.UBR) {
            ...
            Write-Host -ForegroundColor DarkGray "========================================================================="
            Write-Host -ForegroundColor Cyan "[$(Get-Date -format s)] Update Boot Files"
        ...
        Write-Host -ForegroundColor DarkGray "========================================================================="
        Write-Host -ForegroundColor Cyan "[$(Get-Date -format s)] Dism Component Cleanup"
    ...
    Write-Host -ForegroundColor DarkGray "========================================================================="
    Write-Host -ForegroundColor Cyan "[$(Get-Date -format s)] Create OSDCloud Template ISOs"
    ...
    Write-Host -ForegroundColor DarkGray "========================================================================="
    Write-Host -ForegroundColor Cyan "[$(Get-Date -format s)] Set-OSDCloudTemplate -Name $Name"
...
<#     if ((Test-Path "$env:ProgramData\OSDCloud\Config") -or (Test-Path "$env:ProgramData\OSDCloud\Logs") -or (Test-Path "$env:ProgramData\OSDCloud\Media")) {
        Write-Warning "[$(Get-Date -format s)] Migrating existing OSDCloud Template to $OSDCloudTemplate"
