...
.EXAMPLE
Get-OSDMasterCatalogHPSystem
Don't do this, you will get an almost endless list

.EXAMPLE
$Results = Get-OSDMasterCatalogHPSystem
Yes do this.  Save it in a Variable

.EXAMPLE
Get-OSDMasterCatalogHPSystem -Component BIOS | Out-GridView
...
.NOTES
#>
function Get-OSDMasterCatalogHPSystem {
    [CmdletBinding()]
    param (
    ...
    if ($UseCatalog -eq 'Raw') {
        ...
        Get-OSDMasterCatalogHPPlatformList | ForEach-Object{
