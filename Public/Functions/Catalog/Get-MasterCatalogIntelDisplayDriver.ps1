...
#>
function Get-MasterCatalogIntelDisplayDriver {
    [CmdletBinding()]
    param (
        [ValidateSet('x64','x86')]
        [string]$CompatArch,
    ...
    #   Import Base Catalog
    #=================================================
    $BaseCatalog = Get-Content -Path "$($MyInvocation.MyCommand.Module.ModuleBase)\Catalogs\MASTER\MasterCatalogIntelDisplayDriver.json" -Raw | ConvertFrom-Json
    #=================================================
    #   Filter
    #=================================================
    switch ($CompatArch) {
    ...
    $DriverResults | ConvertTo-Json | Out-File "$env:TEMP\MasterCatalogIntelDisplayDriver.json"
    #=================================================
    #   Return
    #=================================================
