...
.NOTES
#>
function Get-BaseCatalogLenovoDriverPack {
    [CmdletBinding()]
    param (
    ...
    $BuildCatalogFile       = Join-Path $env:TEMP (Join-Path 'OSD' 'BaseCatalogLenovoDriverPack.xml')
    $OfflineCatalogFile		= "$($MyInvocation.MyCommand.Module.ModuleBase)\Catalogs\BASE\BaseCatalogLenovoDriverPack.xml"
    #=================================================
    #   Create Paths
    #=================================================
