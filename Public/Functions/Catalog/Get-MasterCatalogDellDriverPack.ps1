...
.NOTES
#>
function Get-MasterCatalogDellDriverPack {
    [CmdletBinding()]
    param (
    ...
    $BuildCatalogFile		= Join-Path $env:TEMP (Join-Path 'OSD' 'MasterCatalogDellDriverPack.xml')
    $OfflineCatalogFile		= "$($MyInvocation.MyCommand.Module.ModuleBase)\Catalogs\MASTER\MasterCatalogDellDriverPack.xml"
