...
.NOTES
#>
function Get-MasterCatalogLenovoDriverPack {
    [CmdletBinding()]
    param (
    ...
    $BuildCatalogFile       = Join-Path $env:TEMP (Join-Path 'OSD' 'MasterCatalogLenovoDriverPack.xml')
    $OfflineCatalogFile		= "$($MyInvocation.MyCommand.Module.ModuleBase)\Catalogs\MASTER\MasterCatalogLenovoDriverPack.xml"
    #=================================================
    #   Create Paths
    #=================================================
