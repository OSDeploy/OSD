...
#>
function Get-BaseCatalogIntelDisplayDriver {
    [CmdletBinding()]
    param (
        [ValidateSet('x64','x86')]
        [string]$CompatArch,
    ...
    #   Import Base Catalog
    #=================================================
    $BaseCatalog = Get-Content -Path "$($MyInvocation.MyCommand.Module.ModuleBase)\Catalogs\BASE\BaseCatalogIntelDisplayDriver.json" -Raw | ConvertFrom-Json
    #=================================================
    #   Filter
    #=================================================
    switch ($CompatArch) {
    ...
    $DriverResults | ConvertTo-Json | Out-File "$env:TEMP\BaseCatalogIntelDisplayDriver.json"
    #=================================================
    #   Return
    #=================================================
