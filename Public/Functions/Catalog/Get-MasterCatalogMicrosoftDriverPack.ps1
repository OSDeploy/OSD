...
.NOTES
#>
function Get-MasterCatalogMicrosoftDriverPack {
    [CmdletBinding()]
    param (
...
'@
    ...
    $BuildCatalogFile		= Join-Path $env:TEMP (Join-Path 'OSD' 'MasterCatalogMicrosoftDriverPack.json')
    $OfflineCatalogFile     = "$($MyInvocation.MyCommand.Module.ModuleBase)\Catalogs\MASTER\MasterCatalogMicrosoftDriverPack.json"
