...
.NOTES
#>
function Get-MasterCatalogLenovoBios {
    [CmdletBinding()]
    param (
    ...
    $BuildCatalogFile		= Join-Path $env:TEMP (Join-Path 'OSD' 'MasterCatalogLenovoBios.xml')
	$OfflineCatalogFile     = "$($MyInvocation.MyCommand.Module.ModuleBase)\Catalogs\MASTER\MasterCatalogLenovoBios.xml"
    #=================================================
    #   Create Paths
    #=================================================
