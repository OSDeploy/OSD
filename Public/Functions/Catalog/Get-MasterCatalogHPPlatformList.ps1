...
.NOTES
#>
function Get-MasterCatalogHPPlatformList {
    [CmdletBinding()]
    param ()
    #=================================================
    #   Paths
    ...
    $BuildCatalogFile		= Join-Path $env:TEMP (Join-Path 'OSD' 'MasterCatalogHPPlatformList.xml')
    $OfflineCatalogFile     = "$($MyInvocation.MyCommand.Module.ModuleBase)\Catalogs\MASTER\MasterCatalogHPPlatformList.xml"
