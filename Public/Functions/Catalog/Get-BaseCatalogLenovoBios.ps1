...
.NOTES
#>
function Get-BaseCatalogLenovoBios {
    [CmdletBinding()]
    param (
    ...
    $BuildCatalogFile		= Join-Path $env:TEMP (Join-Path 'OSD' 'BaseCatalogLenovoBios.xml')
	$OfflineCatalogFile     = "$($MyInvocation.MyCommand.Module.ModuleBase)\Catalogs\BASE\BaseCatalogLenovoBios.xml"
    #=================================================
    #   Create Paths
    #=================================================
