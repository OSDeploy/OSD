...
#>
function Get-MasterCatalogIntelWirelessDriver {
    [CmdletBinding()]
    param (
        [ValidateSet('x64','x86')]
        [string]$CompatArch,
    ...
    #   Import Base Catalog
    #=================================================
    $BaseCatalog = Get-Content -Path "$($MyInvocation.MyCommand.Module.ModuleBase)\Catalogs\MASTER\MasterCatalogIntelWirelessDriver.json" -Raw | ConvertFrom-Json
    #=================================================
    #   Online
    #=================================================
    ...
    $DriverResults | ConvertTo-Json | Out-File "$env:TEMP\MasterCatalogIntelWirelessDriver.json"
    #=================================================
    #   Filter
    #=================================================
    switch ($CompatArch) {
