function Get-HpDriverPack {
    ...
    #   Get Catalog
    #=================================================
    $Results = Get-HPDriverPackMasterCatalog | Select-Object CatalogVersion, Status, @{Name='ReleaseDate';Expression={($_.DateReleased)}}, @{Name='Name';Expression={($_.Model)}}, @{Name='Product';Expression={($_.SystemId)}}, @{Name='DriverPackUrl';Expression={($_.Url)}}, FileName
    #=================================================
    #   DownloadPath
    #=================================================
