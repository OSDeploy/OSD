...
function Get-LenovoBiosCatalog {
    ...
    $BuildCatalogFile		= Join-Path $env:TEMP (Join-Path 'OSD' 'LenovoBiosCatalog.xml')
	$OfflineCatalogFile     = "$($MyInvocation.MyCommand.Module.ModuleBase)\Catalogs\LenovoBiosCatalog.xml"
    #=================================================
    #   Create Paths
    #=================================================
