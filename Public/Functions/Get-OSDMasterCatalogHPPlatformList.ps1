...
.EXAMPLE
Get-OSDMasterCatalogHPPlatformList
Don't do this, you will get a big list.

.EXAMPLE
$Results = Get-OSDMasterCatalogHPPlatformList
Yes do this.  Save it in a Variable

.EXAMPLE
Get-OSDMasterCatalogHPPlatformList | Out-GridView
...
.NOTES
#>
function Get-OSDMasterCatalogHPPlatformList {
    [CmdletBinding()]
    param ()
    #=================================================
    #   Paths
