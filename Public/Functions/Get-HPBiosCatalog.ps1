...
function Get-HPBiosCatalog {
    ...
    if ($PSBoundParameters.ContainsKey('Compatible')) {
	    Get-OSDMasterCatalogHPSystem -Component BIOS -Compatible | Sort-Object -Property CreationDate -Descending
    }
    else {
        Get-OSDMasterCatalogHPSystem -Component BIOS | Sort-Object -Property CreationDate -Descending
    }
}