...
function Get-HPDriverCatalog {
    ...
    if ($PSBoundParameters.ContainsKey('Compatible')) {
	    Get-OSDMasterCatalogHPSystem -Component Driver -Compatible | Sort-Object -Property CreationDate -Descending
    }
    else {
        Get-OSDMasterCatalogHPSystem -Component Driver | Sort-Object -Property CreationDate -Descending
    }
}