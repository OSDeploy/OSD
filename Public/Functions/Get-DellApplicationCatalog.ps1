...
function Get-DellApplicationCatalog {
    ...
    if ($PSBoundParameters.ContainsKey('Compatible')) {
	    Get-OSDMasterCatalogDellSystem -Component Application -Compatible | Sort-Object -Property ReleaseDate -Descending
    }
    else {
        Get-OSDMasterCatalogDellSystem -Component Application | Sort-Object -Property ReleaseDate -Descending
    }
}