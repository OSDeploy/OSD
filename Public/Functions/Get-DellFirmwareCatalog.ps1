...
function Get-DellFirmwareCatalog {
    ...
    if ($PSBoundParameters.ContainsKey('Compatible')) {
	    Get-OSDMasterCatalogDellSystem -Component Firmware -Compatible | Sort-Object -Property ReleaseDate -Descending
    }
    else {
        Get-OSDMasterCatalogDellSystem -Component Firmware | Sort-Object -Property ReleaseDate -Descending
    }
}