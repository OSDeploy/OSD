...
function Get-DellBiosCatalog {
    ...
    if ($PSBoundParameters.ContainsKey('Compatible')) {
	    Get-OSDMasterCatalogDellSystem -Component BIOS -Compatible | Sort-Object -Property ReleaseDate -Descending
    }
    else {
        Get-OSDMasterCatalogDellSystem -Component BIOS | Sort-Object -Property ReleaseDate -Descending
    }
}