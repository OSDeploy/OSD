function Get-LenovoDriverPack {
    ...
    #   Get Catalog
    #=================================================
    $Results = Get-OSDMasterCatalogLenovoDriverPack | Select-Object CatalogVersion, Status, ReleaseDate, Name, Product, @{Name='DriverPackUrl';Expression={($_.Url)}}, FileName
    #=================================================
    #   DownloadPath
    #=================================================
