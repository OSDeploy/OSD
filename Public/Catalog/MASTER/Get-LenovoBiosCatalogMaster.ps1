...
.NOTES
#>
function Get-LenovoBiosCatalogMaster {
    [CmdletBinding()]
    param (
    ...
    $BuildCatalogFile		= Join-Path $env:TEMP (Join-Path 'OSD' 'LenovoBiosCatalogMaster.xml')
	$OfflineCatalogFile     = "$($MyInvocation.MyCommand.Module.ModuleBase)\Catalogs\LenovoBiosCatalogMaster.xml"
    #=================================================
    #   Create Paths
    #=================================================
