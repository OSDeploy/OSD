function Get-MicrosoftDriverPack {
    ...
    #=================================================
    $Results = Get-MicrosoftDriverPackMasterCatalog | Select-Object CatalogVersion, Status, ReleaseDate, Name, Product, @{Name='DriverPackUrl';Expression={($_.Url)}}, FileName
    #=================================================
    #   DownloadPath
    #=================================================
