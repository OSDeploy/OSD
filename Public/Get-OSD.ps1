...
function Get-OSD {
    ...
    if ($Info) {
        ...
        Write-Host "OSD Module PowerShell Shared Library $OSDModuleVersion" -ForegroundColor Green
        ...
        Write-Host
        Write-Host 'Driver Functions' -ForegroundColor Green
        Write-Host 'Get-OSDDriver - Returns Driver download links for Amd Dell Hp Intel and Nvidia'
        Write-Host
        Write-Host 'Disk Functions' -ForegroundColor Green
        ...
        Write-Host
        Write-Host 'Update the OSD Module' -ForegroundColor Green
        Write-Host 'Update-Module OSD -Force'
        Write-Host
        Write-Host "OSD Module Collaborators" -ForegroundColor Green
        ...
        Write-Host "@SeguraOSD" -ForegroundColor Cyan
        Write-Host "Donna Ryan " -NoNewline
        Write-Host "@TheNotoriousDRR" -ForegroundColor Cyan
        Write-Host "Gary Blok " -NoNewline
        Write-Host "@gwblok" -ForegroundColor Cyan
        Write-Host "Jerome Bezet-Torres " -NoNewline
        Write-Host "@JM2K69" -ForegroundColor Cyan
        Write-Host "Jordan Benzing " -NoNewline
        Write-Host "@JordanTheITguy" -ForegroundColor Cyan
