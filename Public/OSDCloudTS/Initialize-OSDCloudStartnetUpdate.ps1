function Initialize-OSDCloudStartnetUpdate {
    ...
    Write-Host -ForegroundColor DarkGray "$($TimeSpan.ToString("mm':'ss")) Start PowerShell with Network details (minimized)"
    ...
    Write-Host -ForegroundColor DarkGray 'BIOS Version:' $Win32BIOS.SMBIOSBIOSVersion
    Write-Host -ForegroundColor DarkGray 'BIOS ReleaseDate:' $Win32BIOS.ReleaseDate
    ...
    try {
        ...
        elseif ($Win32Tpm.SpecVersion) {
            ...
            if ($majorVersion -lt 2) {
                ...
                Write-Host -ForegroundColor Cyan "TPM 2.0: Supported"
                Write-Host -ForegroundColor Cyan "Autopilot: Supported"
