...
if ($CustomImageChildItem) {
    $CustomImageChildItem = $CustomImageChildItem | Where-Object {$_.Name -notin $global:OSDCoreOperatingSystems.FileName}
...
$formMainWindowControlStartButton.add_Click({
    ...
    $Global:InvokeOSDCloud = [ordered]@{
        ...
        DriverPackName              = [System.String]$selectedDriverPackName
