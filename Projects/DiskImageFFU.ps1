...
#================================================
$host.ui.RawUI.WindowTitle = "PowerShell Start-DiskImageFFU"
#================================================
#   Test-InWinPE
#================================================
...
LoadForm -XamlPath (Join-Path $Global:MyScriptDir 'DiskImageFFU.xaml')
#================================================
#   GlobalVariables
#================================================
$Global:DiskImageFFU = @{
...
#   Subtitle
#================================================
$Global:DiskImageFFU.ProductName = ($Global:DiskImageFFU.RegCurrentVersion).ProductName

if ($Global:DiskImageFFU.RegCurrentVersion.DisplayVersion -gt 0) {
    $Global:DiskImageFFU.DisplayVersion = ($Global:DiskImageFFU.RegCurrentVersion).DisplayVersion
}
else {
    $Global:DiskImageFFU.DisplayVersion = ($Global:DiskImageFFU.RegCurrentVersion).ReleaseId
}
$Global:DiskImageFFU.BuildNumber = "$($Global:DiskImageFFU.RegCurrentVersion.CurrentBuild).$($Global:DiskImageFFU.RegCurrentVersion.UBR)"
#================================================
#   Content
#================================================
$LabelTitle.Content = $Global:DiskImageFFU.Title
$LabelVersion.Content = $Global:DiskImageFFU.Version
$LabelManufacturer.Content = $Global:DiskImageFFU.Manufacturer
$LabelModel.Content = $Global:DiskImageFFU.Model
$LabelSerialNumber.Content = $Global:DiskImageFFU.SerialNumber
$LabelSubtitle.Content = "$($Global:DiskImageFFU.ProductName) $($Global:DiskImageFFU.DisplayVersion) ($($Global:DiskImageFFU.BuildNumber))"
$LabelBiosVersion.Content = "BIOS: $($Global:DiskImageFFU.BiosVersion)"
$DismDescriptionTextbox.Text = "$($Global:DiskImageFFU.Manufacturer) $($Global:DiskImageFFU.Model) $($Global:DiskImageFFU.SerialNumber)"
#================================================
#   Right Side TPM
#================================================
try {
...
function Start-SourceAction {
    if ($DismActionCombobox.SelectedValue -eq '/Apply-FFU') {
        ...
        if (!($Global:DiskImageFFU.AvailableDisks)) {
            ...
            $Global:DiskImageFFU.AvailableDisks | foreach {
...
function Start-DestinationAction {
    ...
    if ($DismActionCombobox.SelectedValue -eq '/Apply-FFU') {
        ...
        $Global:DiskImageFFU.SourceDiskNumber = (Get-Disk.fixed | Where-Object { $_.Number -eq $Global:ArrayOfDiskNumbers[$DismSourceCombobox.SelectedIndex] }).DiskNumber
        $Global:DiskImageFFU.PhysicalDrive = "\\.\PhysicalDrive$($Global:DiskImageFFU.SourceDiskNumber)"

        $DismCommandTextbox.Text = "Dism.exe /Apply-FFU /ApplyDrive:$($Global:DiskImageFFU.PhysicalDrive) /?"

        $DismDestinationCombobox.Items.Clear()

        $Global:DiskImageFFU.ApplyDrives = @()
        $Global:DiskImageFFU.ApplyDrives = Get-Disk.storage | Where-Object {$_.DiskNumber -ne $($Global:DiskImageFFU.SourceDiskNumber)}

        if (!($Global:DiskImageFFU.ApplyDrives)) {
            $DismCommandTextbox.Background = "Pink"
            $DismCommandTextbox.Foreground = "Red"
            ...
            foreach ($ApplyDrive in $Global:DiskImageFFU.ApplyDrives) {
    ...
    if ($DismActionCombobox.SelectedValue -eq '/Capture-FFU') {
        ...
        $DismCommandTextbox.Text = "Dism.exe /Capture-FFU /CaptureDrive:$($Global:DiskImageFFU.PhysicalDrive) /?"
        ...
        if (!($Global:DiskImageFFU.ApplyDrives)) {
            ...
            Show-DismDestination
            #Dism Name
            $Global:DiskImageFFU.Name = "disk$($Global:DiskImageFFU.SourceDiskNumber)"
            $DismNameTextbox.Text = $Global:DiskImageFFU.Name

            foreach ($DestinationDrive in $Global:DiskImageFFU.ApplyDrives) {
                if ($DestinationDrive.DriveLetter -gt 0) {
                    $Global:DiskImageFFU.ImageFile = "$($DestinationDrive.DriveLetter):\Images\$($Global:DiskImageFFU.Manufacturer)\$($Global:DiskImageFFU.Model)\$($Global:DiskImageFFU.SerialNumber)_$($Global:DiskImageFFU.Name).ffu"
                    $DismDestinationCombobox.Items.Add($Global:DiskImageFFU.ImageFile) | Out-Null
                }
            }
            $DismDestinationCombobox.SelectedIndex = 0
            $DismDestinationCombobox.IsEditable = "True"
...
function Set-DismCommandApplyFFU {
    $DismCommandTextbox.Text = "Dism.exe /Apply-FFU /ApplyDrive:$($Global:DiskImageFFU.PhysicalDrive) /ImageFile=`"$($DismDestinationCombobox.Text)`""
}
function Set-DismCommandCaptureFFU {
    $DismCommandTextbox.Text = "Dism.exe /Capture-FFU /CaptureDrive:$($Global:DiskImageFFU.PhysicalDrive) /ImageFile=`"$($DismDestinationCombobox.Text)`" /Name:`"$($DismNameTextbox.Text)`" /Description:`"$($DismDescriptionTextbox.Text)`" /Compress:$($DismCompressCombobox.SelectedValue)"
}
#================================================
...
$StartButton.add_Click({
    ...
    if ($DismActionCombobox.SelectedValue -eq '/Apply-FFU') {
        ...
        elseif (!(Test-InWinPE)) {
            ...
            $Global:DismParams = @{
                Dism = '/Apply-FFU'
                ApplyDrive = $Global:DiskImageFFU.PhysicalDrive
    ...
    if ($DismActionCombobox.SelectedValue -eq '/Capture-FFU') {
        ...
        elseif (!(Test-InWinPE)) {
            ...
            $Global:DismParams = @{
                Dism = '/Capture-FFU'
                CaptureDrive = $Global:DiskImageFFU.PhysicalDrive
                ImageFile = $DismDestinationCombobox.Text
