...
function Set-ScriptIndex {
    ...
    $Global:OSDScripts | Where-Object {$_.Script -match $formMainWindowControlScriptFilter.Text} | Where-Object {$_.Content -match $formMainWindowControlScriptContains.Text} | ForEach-Object {
...
function Set-ScriptFilter {
    $formMainWindowControlScriptIndex.Items.Clear()
    $formMainWindowControlScriptIndex.SelectedIndex = 0
    $Global:OSDScripts | Where-Object {$_.Script -match $formMainWindowControlScriptFilter.Text} | ForEach-Object {
        $formMainWindowControlScriptIndex.Items.Add($_.Script) | Out-Null
    }
}
function Set-ScriptContains {
    $formMainWindowControlScriptIndex.Items.Clear()
    $formMainWindowControlScriptIndex.SelectedIndex = 0
    $Global:OSDScripts | Where-Object {$_.Content -match $formMainWindowControlScriptContains.Text} | ForEach-Object {
        $formMainWindowControlScriptIndex.Items.Add($_.Script) | Out-Null
    }
}
function Set-ScriptContent {
    $Global:CurrentScript = $Global:OSDScripts | Where-Object {$_.Script -eq $formMainWindowControlScriptIndex.SelectedValue}
