<#PSScriptInfo
.VERSION 22.4.28.1
.GUID d49049c7-6ae3-42ae-8b64-a632809b460a
...
.NOTES
    Version 22.4.28.1
.LINK
    https://raw.githubusercontent.com/OSDeploy/OSD/master/cloudscript/dev/re.ps1
.EXAMPLE
#>
[CmdletBinding()]
param()
...
if ($WindowsPhase -eq 'Windows') {
    $fromIsoUrl = 'https://cdsosd.blob.core.windows.net/private/OSDCloud_22.4.28.1.iso?sp=r&st=2022-04-28T18:40:09Z&se=2022-05-01T02:40:09Z&sv=2020-08-04&sr=b&sig=X5tGz4cJG2VZXNHdm5tjp5gApPgGwrIh%2B%2FnxMHqREKg%3D'
