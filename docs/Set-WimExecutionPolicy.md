...
Module Name: OSD
online version: https://osd.osdeploy.com/module/functions/dism/set-wimexecutionpolicy
schema: 2.0.0
---
...
```
Set-WimExecutionPolicy [-ExecutionPolicy] <String> -ImagePath <String[]> [-Index <UInt32>] [<CommonParameters>]
```
...
[https://osd.osdeploy.com/module/functions/dism/set-wimexecutionpolicy](https://osd.osdeploy.com/module/functions/dism/set-wimexecutionpolicy)
