...
@{
    ...
    FunctionsToExport       = @(
        ...
        'Get-OSDGather',
        'Get-OSDHelp',
        'Get-OSDMasterCatalogDellDriverPack',
        'Get-OSDMasterCatalogDellSystem',
        'Get-OSDMasterCatalogHPDriverPack',
        'Get-OSDMasterCatalogHPPlatformList',
        'Get-OSDMasterCatalogHPSystem',
        'Get-OSDMasterCatalogIntelDisplayDriver',
        'Get-OSDMasterCatalogIntelRadeonDisplayDriver',
        'Get-OSDMasterCatalogIntelWirelessDriver',
        'Get-OSDMasterCatalogLenovoBios',
        'Get-OSDMasterCatalogLenovoDriverPack',
