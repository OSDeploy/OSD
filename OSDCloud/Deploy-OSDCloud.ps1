...
#=======================================================================
[Version]$MinimumVersion = '21.4.19.3'

if ((Get-Module -Name OSD -ListAvailable | `Sort-Object Version -Descending | Select-Object -First 1).Version -lt $MinimumVersion) {
    Write-Warning "OSDCloud requires OSD $MinimumVersion or newer"
...
if (!($OSDCloudSkipAutopilot -eq $true)) {
    ...
    if ($OSDCloudAutopilotOutString) {
        ...
        $Global:OSDCloudAutopilotOutString | Format-List
    }
    else {
