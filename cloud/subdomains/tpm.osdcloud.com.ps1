...
function Get-Win32Tpm {
    ...
    Write-Host "[$(Get-Date -format s)] Get Win32_Tpm" -ForegroundColor Cyan
...
function Test-Win32Tpm {
    Write-Host -ForegroundColor DarkGray '========================================================================='
    Write-Host "[$(Get-Date -format s)] Test Win32_Tpm" -ForegroundColor Cyan
...
function Test-Win32TpmIsReady {
    Write-Host -ForegroundColor DarkGray '========================================================================='
    Write-Host "[$(Get-Date -format s)] Get Win32_Tpm IsReadyInformation" -ForegroundColor Cyan
...
function Test-TpmToolGetDeviceInformation {
    Write-Host -ForegroundColor DarkGray '========================================================================='
    Write-Host "[$(Get-Date -format s)] Test tpmtool.exe GetDeviceInformation" -ForegroundColor Cyan
...
function Test-TpmMaintenanceTaskComplete {
    Write-Host -ForegroundColor DarkGray '========================================================================='
    Write-Host "[$(Get-Date -format s)] Test TPM Maintenance Task Complete" -ForegroundColor Cyan
...
function Test-TpmCertReqEnrollAIK {
    Write-Host -ForegroundColor DarkGray '========================================================================='
    Write-Host "[$(Get-Date -format s)] CertReq -EnrollAIK -Config `"`"" -ForegroundColor Cyan
    CertReq -EnrollAIK -Config `"`"
}
function Test-RegistryEKCertificates {
    Write-Host -ForegroundColor DarkGray '========================================================================='
    $RegistryPath = $Global:TpmCloudConfig.EKCertificatesRegPath
    Write-Host "[$(Get-Date -format s)] Test EKCert in the Registry" -ForegroundColor Cyan
...
function Test-RegistryWBCL {
    ...
    Write-Host "[$(Get-Date -format s)] Test Windows Boot Configuration Log in the Registry" -ForegroundColor Cyan
    Write-Host "$RegistryPath" -ForegroundColor DarkGray
...
function Test-RegistrySetupDisplayedEula {
    ...
    Write-Host "[$(Get-Date -format s)] Test Windows OOBE SetupDisplayedEula in the Registry" -ForegroundColor Cyan
    Write-Host "$RegistryPath" -ForegroundColor DarkGray
...
function Test-AutopilotWindowsLicense {
    Write-Host -ForegroundColor DarkGray '========================================================================='
    Write-Host "[$(Get-Date -format s)] Test Windows License for Autopilot" -ForegroundColor Cyan
...
function Get-MDMDiagnosticsTool {
    Write-Host -ForegroundColor DarkGray '========================================================================='
    Write-Host "[$(Get-Date -format s)] MDMDiagnosticsTool CollectLog" -ForegroundColor Cyan
...
function Get-EKCertificates {
    Write-Host -ForegroundColor DarkGray '========================================================================='
    Write-Host "[$(Get-Date -format s)] Get-TpmEndorsementKeyInfo - EK Certificates" -ForegroundColor Cyan
...
function Get-WprLoggingStatus {
    Write-Host -ForegroundColor DarkGray '========================================================================='
    Write-Host "[$(Get-Date -format s)] Get-WprLoggingStatus" -ForegroundColor Cyan
    Write-Host "wpr.exe -status" -ForegroundColor DarkGray
    wpr.exe -status
}
function Stop-WprLogging {
    Write-Host -ForegroundColor DarkGray '========================================================================='
    Write-Host "[$(Get-Date -format s)] Stop-WprLogging" -ForegroundColor Cyan
...
function Start-WprLogging {
    Write-Host -ForegroundColor DarkGray '========================================================================='
    Write-Host "[$(Get-Date -format s)] Start-WprLogging" -ForegroundColor Cyan
...
function Test-AutopilotUrl {
    Write-Host -ForegroundColor DarkGray '========================================================================='
    Write-Host "[$(Get-Date -format s)] Test Autopilot URLs" -ForegroundColor Cyan
...
function Test-AzuretUrl {
    Write-Host -ForegroundColor DarkGray '========================================================================='
    Write-Host "[$(Get-Date -format s)] Test Azure URLs" -ForegroundColor Cyan
    $Server = 'azure.net'
    $Port = 443
    $Message = "Test port $Port on $Server"
    $NetConnection = (Test-NetConnection -ComputerName $Server -Port $Port).TcpTestSucceeded
...
function Test-TpmUrl {
    Write-Host -ForegroundColor DarkGray '========================================================================='
    Write-Host "[$(Get-Date -format s)] Test TPM URLs" -ForegroundColor Cyan
...
function Test-WindowsTimeService {
    Write-Host -ForegroundColor DarkGray '========================================================================='
    Write-Host "[$(Get-Date -format s)] Test Windows Time Service" -ForegroundColor Cyan
...
function Export-TpmRegistry {
    Write-Host -ForegroundColor DarkGray '========================================================================='
    Write-Host "[$(Get-Date -format s)] Export TPM Registry" -ForegroundColor Cyan
